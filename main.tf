...
#    {name = "dev.expense.frontend.backend_url", value = "http://backend-dev.yamunadevops.online/", type = "String"},
    ...
    {name = "dev.roboshop.user.REDIS_HOST", value = "dev-elasticache-001.dev-elasticache.jfm15k.use1.cache.amazonaws.com", type = "String"},
    {name = "dev.roboshop.cart.REDIS_HOST", value = "dev-elasticache-001.dev-elasticache.jfm15k.use1.cache.amazonaws.com", type = "String"},
